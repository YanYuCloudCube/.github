...
YYC³（YanYuCloudCube）Family AI 是一个**开源本地优先**的 AI 智能编程助手，**高度可定制**：主题、Logo、模型、面板自由配置；基于 React/TypeScript 构建，通过集成六大主流 LLM Provider 和 MCP 服务生态，提供智能代码生成、实时预览、任务管理等全方位的 AI 辅助编程体验。
